...
class CompraVentaProductoTest extends TestCase
{
    ...
    public function testComprarProductos()
    {
        ...
        $this->assertDatabaseHas('registro_stock', ['id_producto' => 2, 'cantidad' => 10, 'precio' => 30, 'tipo' => 'Compra']);
        $this->assertDatabaseHas('productos', ['id' => 1, 'precio_compra' => 10, 'cantidad' => 25]);
        $this->assertDatabaseHas('productos', ['id' => 2, 'precio_compra' => 30, 'cantidad' => 30]);
        ...
        $this->assertDatabaseHas('movimientos', ['ingreso' => 0, 'egreso' => 300, 'observacion' => null, 'tipo_pago' => 'Efectivo', 'fecha' => Carbon::today()->toDateString()]);
    ...
    {
        factory(Producto::class, 3)->create(['cantidad' => 20]);
        $data = ['observacion' => null, 'tipoPago' => 'Efectivo', 'idSocio' => 1, 'productos' => [['id' => 1, 'cantidad' => 5, 'precio' => 10], ['id' => 2, 'cantidad' => 10, 'precio' => 30]]];
        ...
        $this->assertDatabaseHas('registro_stock', ['id_producto' => 2, 'cantidad' => 10, 'precio' => 30, 'tipo' => 'Venta', 'id_usuario' => 1]);
        $this->assertDatabaseHas('productos', ['id' => 1, 'precio_venta' => 10, 'cantidad' => 15]);
        $this->assertDatabaseHas('productos', ['id' => 2, 'precio_venta' => 30, 'cantidad' => 10]);
        ...
        $this->assertDatabaseHas('movimientos', ['ingreso' => 300, 'egreso' => 0, 'observacion' => null, 'tipo_pago' => 'Efectivo', 'fecha' => Carbon::today()->toDateString()]);
    }
